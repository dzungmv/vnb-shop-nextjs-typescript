const FeaturesComp = () => {
    return (
        <section className=' max-w-[1200px] mx-auto grid grid-cols-3 grid-rows-[300px_100px_300px] gap-5 mt-28 mobile:grid-cols-1 mobile:grid-rows-[250px_250px_250px_250px_250px]'>

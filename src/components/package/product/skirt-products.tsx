...
const SkirtProductsPage: React.FC = () => {
    ...
    const HANDLE = {
        loadMore: async () => {
            try {
                const res = await axios.get(
                    `${process.env.SERVER_URL}/product/get-products?page=${page}&limit=12&type=skirt&sort=${sort}&brand=${brand}&price=${price}&stores=${stores}`
                );
        ...
        sortPriceIncreasing: async () => {
            ...
            const res = await axios.get(
                `${process.env.SERVER_URL}/product/get-products?page=1&limit=12&type=skirt&sort=price_asc&brand=${brand}&price=${price}&stores=${stores}`
            );
        ...
        sortPriceDecreasing: async () => {
            ...
            const res = await axios.get(
                `${process.env.SERVER_URL}/product/get-products?page=1&limit=12&type=skirt&sort=${sort}&brand=${brand}&price=${price}&stores=${stores}`
            );
...
SkirtProductsPage.displayName = 'SkirtProductsPage';

export default SkirtProductsPage;

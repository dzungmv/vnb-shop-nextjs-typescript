...
const RacketProductsPage: React.FC = () => {
    ...
    const HANDLE = {
        loadMore: async () => {
            try {
                const res = await axios.get(
                    `${process.env.SERVER_URL}/product/get-products?page=${page}&limit=12&type=racket&sort=${sort}&brand=${brand}&price=${price}&stores=${stores}`
                );
        ...
        sortPriceIncreasing: async () => {
            ...
            const res = await axios.get(
                `${process.env.SERVER_URL}/product/get-products?page=1&limit=12&type=racket&sort=price_asc&brand=${brand}&price=${price}&stores=${stores}`
            );
        ...
        sortPriceDecreasing: async () => {
            ...
            const res = await axios.get(
                `${process.env.SERVER_URL}/product/get-products?page=1&limit=12&type=racket&sort=${sort}&brand=${brand}&price=${price}&stores=${stores}`
            );
...
RacketProductsPage.displayName = 'RacketProductsPage';

export default RacketProductsPage;

...
const ShirtProductsPage: React.FC = () => {
    ...
    const HANDLE = {
        loadMore: async () => {
            try {
                const res = await axios.get(
                    `${process.env.SERVER_URL}/product/get-products?page=${page}&limit=12&type=shirt&sort=${sort}&brand=${brand}&price=${price}&stores=${stores}`
                );
        ...
        sortPriceIncreasing: async () => {
            ...
            const res = await axios.get(
                `${process.env.SERVER_URL}/product/get-products?page=1&limit=12&type=shirt&sort=price_asc&brand=${brand}&price=${price}&stores=${stores}`
            );
        ...
        sortPriceDecreasing: async () => {
            ...
            const res = await axios.get(
                `${process.env.SERVER_URL}/product/get-products?page=1&limit=12&type=shirt&sort=${sort}&brand=${brand}&price=${price}&stores=${stores}`
            );
            ...
            <section className='max-w-[1260px] mx-auto mt-8 flex gap-5 items-start'>
                ...
                <div className='w-[77%] tablet:w-full'>
                    <header className='flex items-center justify-between'>
                        <h2 className='font-medium text-xl'>Badminton Shirt</h2>
...
ShirtProductsPage.displayName = 'ShirtProductsPage';
